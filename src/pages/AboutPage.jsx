                      ...
                      <li>
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="tl-body">
                            ...
                            <p>
                              Aliquam molestie urna sed pharetra vestibulumentum
                              sapien euismod onec rhoncus ex sed tiss eget
                              eronmsedf agnaimperdiet sodala aliquam.
                            </p>
                          </div>
                        </div>
                      </li>
                      <li className="timeline-inverted">
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="tl-body">
                            <h4>Heading of History</h4>
                            <p>
                              Eollicitudin ex eu tortor ornare vulputate estibulum
                              entum sapien euismod onec rhoncus ex sed tiss eget
                              seromsern agnaimperdiet sodala aliquam.
                            </p>
                          </div>
                        </div>
                      </li>
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="tl-body">
                            ...
                            <p>
                              ...
                              estibulum entum sapien euismod onec rhoncus ex sed
                              tiss eget agnaimperdiet sodala aliquam.
                            </p>
                          </div>
                        </div>
                      </li>
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="tl-body">
                            ...
                            <p>
                              ...
                              finibus turpis aornare eros lorem vitae exuis vitae
                              eleifend diam phasellus ullamcornisi utellus luctus
                              porttiton.
                            </p>
                          </div>
                        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className="box">
                <div className="box-head">
                  <h2 className="head-title">Happy Customers Says</h2>
                </div>
                <div className="box-body">
                  <div className="row">
                    <div className="testimonial-carousel">
                      <div className="owl-carousel owl-three owl-theme">
                        <div className="item">
                          <div className="testimonial-block">
                            <div className="testimonial-content">
                              <p className="testimonial-text">
                                “Sed sollicitudiexeu tortor ornare vulputate
                                loremip estibulum entumser sapien euismod onec
                                rhoncsex sed tiss eget agnaimperdiet sodalaserom
                                aliquam exeu tortor ornare vulputate estibulum
                                entum”
                              </p>
                              <h4>Henry Odom</h4>
                              <span className="text-default">(Ahemedabad)</span>
                            </div>
                          </div>
                        </div>
                        <div className="item">
                          <div className="testimonial-block">
                            <div className="testimonial-content">
                              <p className="testimonial-text">
                                “Nulla pretium ineratac consequvamus auctor massa
                                nlin facilisis magna scelerisque egunc pharetra
                                finibus enimeu convatiae velit id justoas sagittis
                                laccumsan lobortis”
                              </p>
                              <h4>George Walker</h4>
                              <span className="text-default">(Baroda)</span>
                            </div>
                          </div>
                        </div>
                        <div className="item">
